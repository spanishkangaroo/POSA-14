...
public class PingPongRight {
    ...
    public static class PlayPingPongThread extends Thread {
        ...
        public PlayPingPongThread(String stringToPrint,
        	...
        	this.semaphoreArray[FIRST_SEMA] = semaphoreOne;
        	this.semaphoreArray[SECOND_SEMA] = semaphoreTwo;
        ...
        private void acquire() {
            // TODO fill in here
        	SimpleSemaphore firstSemaphore = this.semaphoreArray[FIRST_SEMA];
        ...
        private void release() {
            // TODO fill in here
        	SimpleSemaphore secondSemaphore = this.semaphoreArray[SECOND_SEMA];
